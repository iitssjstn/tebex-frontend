...
export const DEFAULT_LABELS = {
  ...
  fromPrice: "From",
  duration: "Duration",
  recurringNote: "Renews automatically until you cancel.",
  saveVsMonthly: "Save {percent}% compared to monthly",
  usernameTitle: "Enter your Minecraft username",
  usernameText: "Your purchase is delivered to this account. Check the spelling, it cannot be changed after payment.",
  usernamePlaceholder: "Minecraft username",
  usernameContinue: "Continue",
  usernameInvalid: "That Minecraft username was not accepted. Check the spelling.",
  usernameChange: "Change",
  playingAs: "Delivering to",
  cancel: "Cancel",
